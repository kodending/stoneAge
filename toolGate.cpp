...
toolType * toolGate::inputHandle(mapTool * mapTool)
{
	//나가기 버튼을 눌렀을때 비우기 위한
...
void toolGate::update(mapTool * mapTool)
{
...
void toolGate::enter(mapTool * mapTool)
{
	mapTool->_popUp.img = IMAGEMANAGER->findImage("popUp");
	mapTool->_sampleTile.img = IMAGEMANAGER->findImage("gate");
	mapTool->_currentTile.img = IMAGEMANAGER->findImage("gate");
...
void toolGate::exit(mapTool * mapTool)
{
