...
toolType * toolPlants::inputHandle(mapTool * mapTool)
{
	//나가기 버튼을 눌렀을때 비우기 위한
...
void toolPlants::update(mapTool * mapTool)
{
...
void toolPlants::enter(mapTool * mapTool)
{
	mapTool->_popUp.img = IMAGEMANAGER->findImage("popUp");
	mapTool->_sampleTile.img = IMAGEMANAGER->findImage("plants");
	mapTool->_currentTile.img = IMAGEMANAGER->findImage("plants");
...
void toolPlants::exit(mapTool * mapTool)
{
