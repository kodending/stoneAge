...
void toolTile::update(mapTool * mapTool)
{
...
void toolTile::enter(mapTool * mapTool)
{
	mapTool->_popUp.img = IMAGEMANAGER->findImage("popUp");
	mapTool->_sampleTile.img = IMAGEMANAGER->findImage("tile");
	mapTool->_currentTile.img = IMAGEMANAGER->findImage("tile");
	...
	mapTool->setIsToolTile(true);

	mapTool->_sampleTile.terrainFrameX = 0;
	mapTool->_sampleTile.terrainFrameY = 0;

	mapTool->_toolName.currentFrameX = 0;
	mapTool->_toolName.currentFrameY = 0;

	mapTool->_rightButton.currentFrameX = 0;
	mapTool->_rightButton.currentFrameY = 0;
}

void toolTile::render(mapTool * mapTool)
{
...
void toolTile::exit(mapTool * mapTool)
{
