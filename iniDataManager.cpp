...
void iniDataManager::deleteData(const char * fileName, const char * subject, const char * title)
{
	char str[256];
	char dir[256];
	...
	WritePrivateProfileString(subject, title, NULL, str);
}

void iniDataManager::deleteDataAll(const char * fileName, const char * subject)
{
	char str[256];
	char dir[256];
	...
	WritePrivateProfileString(subject, NULL, NULL, str);
}
