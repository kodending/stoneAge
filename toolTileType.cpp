...
void toolTileType::update(mapTool * mapTool)
{
...
void toolTileType::enter(mapTool * mapTool)
{
	mapTool->_popUp.img = IMAGEMANAGER->findImage("popUp");
	mapTool->_sampleTile.img = IMAGEMANAGER->findImage("tileType");
	mapTool->_currentTile.img = IMAGEMANAGER->findImage("tileType");
	...
	mapTool->setIsToolTileType(true);
...
void toolTileType::render(mapTool * mapTool)
{
...
void toolTileType::exit(mapTool * mapTool)
{
