...
void toolFence::update(mapTool * mapTool)
{
...
void toolFence::enter(mapTool * mapTool)
{
	mapTool->_popUp.img = IMAGEMANAGER->findImage("popUp");
	mapTool->_sampleTile.img = IMAGEMANAGER->findImage("fence");
	mapTool->_currentTile.img = IMAGEMANAGER->findImage("fence");
...
void toolFence::exit(mapTool * mapTool)
{
